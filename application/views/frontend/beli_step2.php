						...
						<input type="hidden" name="tgl" value="<?php echo $tglberangkat ?>">
							...
							<div class="card mb-5">
								<div class="card-header">
									<i class="fas fa-id-card"></i> Koltuk No <?php echo $row; ?>
								</div>
								<div class="card-body">
									<div class="form-group">
										<label for="CN">Yolcu İsmi</label>
										<input type="text" id="" class="form-control" id="" name="nama[]" placeholder="No <?php echo $row ?> koltukta oturan kişinin" required>
									...
									<div class="form-group">
										<select name="tahun[]" class="form-control js-example-basic-single" required>
											...
											for ($x = $thn_skr; $x >= 1; $x--) {
											?>
											<option value="<?php echo $x ?>"><?php echo $x ?> Yaşında</option>
											<?php
											}
											?>
										</select>
											...
											<div class='form-group'>
												...
												<div class='form-group'>
													<div class='col-sm-12'>
												      ...
												      <div style="margin: 20px auto; background-color: red ; color: white; "><a href='javascript:history.back()' class='btn btn-danger pull-center'>Geri Dön</a></div>  
													  <button class="btn btn-success pull-center">Bileti Al</button>
											</div>
										</div>
